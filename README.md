...
ML & DL models for text classification

Evaluation with accuracy and F1-score

🛠 Tech Used

Python, NLTK, spaCy, Scikit-learn, TensorFlow/PyTorch, Hugging Face Transformers
...
A quick, modular, and easy-to-understand NLP pipeline suitable for beginners and developers exploring text analysis.
